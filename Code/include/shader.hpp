...
public:
  ...
  std::vector<std::string> vertex_source;                                                           ///< @brief **OpenGL vertex shader source file.**
  std::vector<std::string> geometry_source;                                                         ///< @brief **OpenGL geometry shader source file.**
  std::vector<std::string> fragment_source;                                                         ///< @brief **OpenGL vertex shader source file.**
  std::vector<GLuint>      vertex;                                                                  ///< @brief **OpenGL vertex shader id.**
  std::vector<GLuint>      geometry;                                                                ///< @brief **OpenGL geometry shader id.**
  std::vector<GLuint>      fragment;                                                                ///< @brief **OpenGL fragment shader id.**
