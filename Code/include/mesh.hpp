...
#define NU_MSH_MAX_NUM                                140                                           // keep this up-to-date when adding new type
...
public:
  std::vector<std::vector<gmsh_node> >    node;                                                     ///< node[i].
  std::vector<std::vector<gmsh_link> >    link;                                                     ///< link.
  std::vector<std::vector<gmsh_element> > element;                                                  ///< element[k].
  std::vector<std::vector<gmsh_group> >   group;                                                    ///< group[i].
  std::vector<std::vector<int> >          neighbourhood;                                            ///< neighbourhood.
  std::vector<std::vector<int> >          offset;                                                   ///< neighbour offset.
