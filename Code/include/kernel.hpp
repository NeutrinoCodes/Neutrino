...
public:
  ...
  string        kernel_home;                                                    //[NU_MAX_PATH_SIZE];  // Kernel home directory.
  string        kernel_file_name;                                               //[NU_MAX_PATH_SIZE];  // Kernel file name.
  string        compiler_options;                                               //[NU_MAX_PATH_SIZE];  // JIT complier options string.
  string        compiler_log;                                                   // OpenCL JIT compiler error log.
