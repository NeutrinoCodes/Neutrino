...
void setup()
{
  ...
  load_kernel(full_name);                                                       // Loading OpenCL kernel source...
  ...
  set_float4(freedom, 15);                                                      // Setting kernel argument #15...
}

void loop()
{
  push_point4(position, 0);                                                     // Pushing kernel argument #0...
  push_color4(color, 1);                                                        // Pushing kernel argument #1...
  push_float4(position_old, 2);                                                 // Pushing kernel argument #2...
  push_float4(velocity, 3);                                                     // Pushing kernel argument #3...
  push_float4(acceleration, 4);                                                 // Pushing kernel argument #4...
  push_float4(gravity, 5);                                                      // Pushing kernel argument #5...
  push_float4(stiffness, 6);                                                    // Pushing kernel argument #6...
  push_float4(resting, 7);                                                      // Pushing kernel argument #7...
  push_float4(friction, 8);                                                     // Pushing kernel argument #8...
  push_float4(mass, 9);                                                         // Pushing kernel argument #9...
  push_int1(index_PC, 10);                                                      // Pushing kernel argument #10...
  push_int1(index_PR, 11);                                                      // Pushing kernel argument #11...
  push_int1(index_PU, 12);                                                      // Pushing kernel argument #12...
  push_int1(index_PL, 13);                                                      // Pushing kernel argument #13...
  push_int1(index_PD, 14);                                                      // Pushing kernel argument #14...
  push_float4(freedom, 15);                                                     // Pushing kernel argument #15...

  execute_kernel();

  pop_point4(position, 0);                                                      // Pushing kernel argument #0...
  pop_color4(color, 1);                                                         // Pushing kernel argument #1...
  pop_float4(position_old, 2);                                                  // Pushing kernel argument #2...
  pop_float4(velocity, 3);                                                      // Pushing kernel argument #3...
  pop_float4(acceleration, 4);                                                  // Pushing kernel argument #4...
  pop_float4(gravity, 5);                                                       // Pushing kernel argument #5...
  pop_float4(stiffness, 6);                                                     // Pushing kernel argument #6...
  pop_float4(resting, 7);                                                       // Pushing kernel argument #7...
  pop_float4(friction, 8);                                                      // Pushing kernel argument #8...
  pop_float4(mass, 9);                                                          // Pushing kernel argument #9...
  pop_int1(index_PC, 10);                                                       // Pushing kernel argument #10...
  pop_int1(index_PR, 11);                                                       // Pushing kernel argument #11...
  pop_int1(index_PU, 12);                                                       // Pushing kernel argument #12...
  pop_int1(index_PL, 13);                                                       // Pushing kernel argument #13...
  pop_int1(index_PD, 14);                                                       // Pushing kernel argument #14...
  pop_float4(freedom, 15);                                                      // Pushing kernel argument #15...
