                      ...
                      )
{
  ...
  float a13 = (right + left)/(right - left);                                    // Setting frustum matrix term...
  float a22 = 2.0*z_near/(top - bottom);                                        // Setting frustum matrix term...
  float a23 = (top + bottom)/(top - bottom);                                    // Setting frustum matrix term...
  float a33 = -(z_far + z_near)/(z_far - z_near);                               // Setting frustum matrix term...
