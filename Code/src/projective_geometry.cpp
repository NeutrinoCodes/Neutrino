                    ...
                    )
{
  ...
  left_shift[1]  = 0;                                                           // Setting left eye y-coordinate...
  left_shift[2]  = 0;                                                           // Setting left eye z-coordinate...

  right_shift[0] = -eye_shift;                                                  // Setting right eye x-coordinate...
  right_shift[1] = 0;                                                           // Setting right eye y-coordinate...
  right_shift[2] = 0;                                                           // Setting right eye z-coordinate...
