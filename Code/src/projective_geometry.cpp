...
)
{
  ...
  M[0] = 1.0f; M[4] = 0.0f; M[8] = 0.0f;  M[12] = t[0];                                             // Building translation...
  M[1] = 0.0f; M[5] = 1.0f; M[9] = 0.0f;  M[13] = t[1];                                             // Building translation...
  M[2] = 0.0f; M[6] = 0.0f; M[10] = 1.0f; M[14] = t[2];                                             // Building translation...
  M[3] = 0.0f; M[7] = 0.0f; M[11] = 0.0f; M[15] = 1.0f;                                             // Building translation...
...

{
  ...
  Q[0]  = M[0]; Q[4] = M[3]; Q[8] = M[6];  Q[12] = 0.0f;                                            // Computing quaternion in matrix form...
  Q[1]  = M[1]; Q[5] = M[4]; Q[9] = M[7];  Q[13] = 0.0f;                                            // Computing quaternion in matrix form...
  Q[2]  = M[2]; Q[6] = M[5]; Q[10] = M[8]; Q[14] = 0.0f;                                            // Computing quaternion in matrix form...
  Q[3]  = 0.0f; Q[7] = 0.0f; Q[11] = 0.0f; Q[15] = 1.0f;                                            // Computing quaternion in matrix form...
...
)
{
  ...
  F[0] = a11;    F[4] = 0.0f;  F[8] = a13;      F[12] = 0.0f;                                       // Setting frustum matrix...
  F[1] = 0.0f;   F[5] = a22;   F[9] = a23;      F[13] = 0.0f;                                       // Setting frustum matrix...
  F[2] = 0.0f;   F[6] = 0.0f;  F[10] = a33;     F[14] = a34;                                        // Setting frustum matrix...
  F[3] = 0.0f;   F[7] = 0.0f;  F[11] = -1.0f;   F[15] = 0.0f;                                       // Setting frustum matrix...
}
...
)
{
  ...
  M[0]           = 1.0f; M[4] = 0.0f; M[8] = 0.0f;  M[12] = 0.0f;                                   // Building matrix for eye translation...
  M[1]           = 0.0f; M[5] = 1.0f; M[9] = 0.0f;  M[13] = 0.0f;                                   // Building matrix for eye translation...
  M[2]           = 0.0f; M[6] = 0.0f; M[10] = 1.0f; M[14] = 0.0f;                                   // Building matrix for eye translation...
  M[3]           = 0.0f; M[7] = 0.0f; M[11] = 0.0f; M[15] = 1.0f;                                   // Building matrix for eye translation...
