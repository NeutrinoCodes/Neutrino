...
int main ()
{
  ...
  for(j = 0; j < NODES_Y; j++)
  {
    for(i = 0; i < NODES_X; i++)
    {
      ...
      C->data[j*NODES_X + i].r = 0.01*(rand () % 100);                          // Setting "r" color coordinate...
      C->data[j*NODES_X + i].g = 0.01*(rand () % 100);                          // Setting "g" color coordinate...
      C->data[j*NODES_X + i].b = 0.01*(rand () % 100);                          // Setting "b" color coordinate...
      C->data[j*NODES_X + i].a = 1.0;                                           // Setting "a" color coordinate...
