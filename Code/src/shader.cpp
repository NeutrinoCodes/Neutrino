                    ...
                    )
{
  ...
  glBindAttribLocation (program, 0, "Px");                                      // Binding "x" coordinate...
  glBindAttribLocation (program, 1, "Py");                                      // Binding "y" coordinate...
  glBindAttribLocation (program, 2, "Pz");                                      // Binding "z" coordinate...
  glBindAttribLocation (program, 3, "Pw");                                      // Binding "w" coordinate...
  glBindAttribLocation (program, 4, "Pr");                                      // Binding "r" color...
  glBindAttribLocation (program, 5, "Pg");                                      // Binding "g" color...
  glBindAttribLocation (program, 6, "Pb");                                      // Binding "b" color...
  glBindAttribLocation (program, 7, "Pa");                                      // Binding "a" color...
