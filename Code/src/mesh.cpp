                ...
                )
{
  ...
  for(i = 0; i < entities.size (); i++)
  {
    ...
    {
      nodes = nodeTags[j];                                                                          // Setting nodes number...
    }
  }
                    ...
                    )
{
  ...
  for(i = 0; i < entities.size (); i++)
  {
    ...
    for(j = 0; j < nodeTags.size (); j++)
    {
      loc_node->data[nodeTags[j]].x = (cl_float)nodeCoords[model_dim*j + 0];                        // Setting "x" coordinate...
      loc_node->data[nodeTags[j]].y = (cl_float)nodeCoords[model_dim*j + 1];                        // Setting "y" coordinate...
      loc_node->data[nodeTags[j]].z = (cl_float)nodeCoords[model_dim*j + 2];                        // Setting "z" coordinate...
      loc_node->data[nodeTags[j]].w = (cl_float)1.0;                                                // Setting "w" coordinate...
