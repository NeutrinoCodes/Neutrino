                   ...
                   )
{
  ...
  for(k = 0; k < loc_all_element_size; k++)
  {
    ...
    if(loc_node_found == loc_type_size)
    {
      ...
      {
        m = loc_element_offset + n;                                                                 // Computing node index...
        element.push_back (loc_all_element_node[m] - 1);                                            // Adding index of node tag to element vector...
      }
  ...
  for(i = 0; i < loc_node_size; i++)
  {
    ...
    for(s = 0; s < loc_neighbour_size; s++)
    {
      ...
      neighbour.push_back (n);                                                                      // Setting neighbour index...
      neighbour_center.push_back (j);                                                               // Setting neighbour center...
