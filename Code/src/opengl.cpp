                   ...
                   )
{
  ...
  {
    orbit_x_old = orbit_x;                                                                          // Backing up orbit_x...
    orbit_y_old = orbit_y;                                                                          // Backing up orbit_y...
  ...
  if((abs (loc_orbit_x) > loc_orbit_threshold) ||
     (abs (loc_orbit_y) > loc_orbit_threshold))
  {
    orbit_x = loc_orbit_x;                                                                          // Getting orbit_x...
    orbit_y = loc_orbit_y;                                                                          // Getting orbit_y...

    arcball (a, orbit_x_old, orbit_y_old);                                                          // Building mouse world vector (old)...
    arcball (b, orbit_x, orbit_y);                                                                  // Building mouse world vector...
    theta   = 0.01*NU_ROTATION_FACTOR*angle (a, b);                                                 // Computing orbit angle...

    if(abs (theta) > 0)                                                                             // Checking for valid rotation angle...
    {
